...
<%--<div class="easyui-layout" style="with: 100%; height: 350px;">--%>
            ...
            <%--<table>--%>
                <%--<tr>--%>
                    ...
                    <%--<td><input id="userName" name="userName" class="easyui-textbox"--%>
                               <%--data-options="prompt: '输入用户名称...'" style="width: 100%; height: 32px"></td>--%>
                    <%--<td>备注</td>--%>
                    <%--<td><input id="note" name="note" class="easyui-textbox" data-options="prompt: '输入备注...'"--%>
                               <%--style="width: 100%; height: 32px;"></td>--%>
                    <%--<td><a href="#" class="easyui-linkbutton" data-options="iconCls: 'icon-search'" style="width: 80px;"--%>
                           <%--onclick="onSearchx()">查询</a></td>--%>
                <%--</tr>--%>
            <%--</table>--%>
        <%--</form>--%>
    <%--</div>--%>
